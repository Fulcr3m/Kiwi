...
int32_t FunctionServlet::handle(kiwi::http::HttpRequest::ptr request
...
int32_t ServletDispatch::handle(kiwi::http::HttpRequest::ptr request
               , kiwi::http::HttpResponse::ptr response
               , kiwi::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(kiwi::http::HttpRequest::ptr request
                   , kiwi::http::HttpResponse::ptr response
                   , kiwi::http::HttpSession::ptr session) {
    static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
        "</title></head><body><center><h1>404 Not Found</h1></center>"
        "<hr><center>kiwi/1.0.0</center></body></html>";

    response->setStatus(kiwi::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "kiwi/1.0.0");
